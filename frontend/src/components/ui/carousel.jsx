...
const CarouselPrevious = React.forwardRef(({ className, variant = "", ...props }, ref) => {
...
const CarouselNext = React.forwardRef(({ className, variant = "", size = "icon", ...props }, ref) => {
  ...
  return (
    (<Button
      ...
      variant={variant}
      size={size}
      className={cn("absolute bg-color_2/70 lg:bg-color_2 hover:bg-color_2 lg:hover:bg-color_2/50 px-10 py-4 rounded-none -skew-y-6", orientation === "horizontal"
