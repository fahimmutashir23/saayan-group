...
const BottomBanner = () => {
  return (
    <div className="bg-color_2 py-5 lg:py-10 px-3 lg:px-20 flex flex-col lg:flex-row justify-around items-center gap-20">
      <div className="font-semibold text-2xl text-white text-center">
        Purpose of a convoy is to keep your term
      </div>
      <div>
        <h1 className="flex flex-col lg:flex-row items-center gap-2 text-xl font-semibold text-white">
          <span className="bg-color_3/90 p-3 rounded-full">
            <MdOutlineNetworkCell className="text-white" />
          </span>
          Build for the impact
        </h1>
        <p className="text-white text-md lg:pl-14 text-center lg:text-left">
